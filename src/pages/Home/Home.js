...
const Home = () => {
  return (
    ...
    >
      {/* CAMBIAR POR IMAGEN PROFESIONAL MIA <Row>
        <ImageHolder
          primarySource={ProfessionalHeadshot}
          secondarySource={FallbackProfessionalHeadshot}
          alt="Professional Headshot of Rubén Pérez"
      ...
      <Row>
        <Col>
          <span className={`${styles.textWhite} ${styles.headingThree}`}>
            Software Engineer, Data Scientist, MSc Student
          </span>
        </Col>
      </Row>
      <Row>
        <Col>
          <a href="https://www.github.com/rubenperezm" target="_blank_">
            <FaGithubSquare className={styles.icon} />
          </a>
        </Col>
        <Col>
          <a href="https://www.linkedin.com/in/rubenperezmercado" target="_blank_">
