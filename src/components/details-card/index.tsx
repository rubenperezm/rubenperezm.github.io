...
import { SiResearchgate, SiTwitter, SiUdemy, SiLeetcode, SiGooglescholar } from 'react-icons/si';
  ...
  return (
    <div className="flex justify-start py-2 px-1 items-center">
      ...
      <div
        className={`${
          skeleton ? 'flex-grow' : ''
        } text-sm font-normal text-right mr-2 ml-3 ${link ? 'truncate hover:text-primary hover:underline' : ''}`}
        style={{
            ...
            <Fragment>
              ...
              {social?.scholar && (
                <ListItem
                  ...
                  title="Scholar:"
                  value={"Rubén Pérez Mercado"} // Hardcoded name
